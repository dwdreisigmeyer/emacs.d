...
(defun the-theme ()
  "Hacked this from color-theme-kingsajz"
  ...
  (color-theme-install
   '(color-theme-kingsajz
     ...
     (default ((t (:stipple nil :background "black" :foreground "snow4" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "outline-andale mono"))))
     (bbdb-field-name ((t (:foreground "green"))))
     (bg:erc-color-face0 ((t (:background "grey80"))))
     ...
     (custom-modified-face ((t (:background "blue" :foreground "grey80"))))
     (custom-rogue-face ((t (:background "black" :foreground "pink"))))
     (custom-saved-face ((t (:underline t))))
     (custom-set-face ((t (:background "grey80" :foreground "blue"))))
     (custom-state-face ((t (:foreground "Coral"))))
     (custom-variable-button-face ((t (:underline t))))
     (custom-variable-tag-face ((t (:foreground "MediumOrchid"))))
     ...
     (dired-face-flagged ((t (:foreground "firebrick"))))
     (dired-face-marked ((t (:foreground "light RoyalBlue"))))
     (dired-face-permissions ((t (:foreground "MediumOrchid"))))
     ...
     (erc-notice-face ((t (:foreground "light RoyalBlue"))))
     ...
     (eshell-ls-directory-face ((t (:bold t :foreground "peru" :weight bold))))
     ...
     (eshell-ls-product-face ((t (:foreground "firebrick"))))
     (eshell-ls-readonly-face ((t (:foreground "MediumOrchid"))))
     (eshell-ls-special-face ((t (:bold t :foreground "Gold" :weight bold))))
     (eshell-ls-symlink-face ((t (:bold t :foreground "grey80" :weight bold))))
     (eshell-ls-text-face ((t (:foreground "medium aquamarine"))))
     (eshell-ls-todo-face ((t (:bold t :foreground "MediumOrchid" :weight bold))))
     ...
     (fg:erc-color-face0 ((t (:foreground "grey80"))))
     ...
     (font-lock-comment-face ((t (:foreground "grey80"))))
     (font-lock-constant-face ((t (:bold t :foreground "MediumOrchid" :weight bold))))
     (font-lock-doc-face ((t (:italic t :slant italic :foreground "firebrick"))))
     (font-lock-doc-string-face ((t (:foreground "firebrick"))))
     (font-lock-function-name-face ((t (:bold t :foreground "peru" :weight bold))))
     ...
     (font-lock-string-face ((t (:italic t :foreground "firebrick" :slant italic))))
     (font-lock-type-face ((t (:bold t :foreground "YellowGreen" :weight bold))))
     (font-lock-variable-name-face ((t (:italic t :bold t :foreground "MediumOrchid" :slant italic :weight bold))))
     ...
     (gnus-cite-face-3 ((t (:foreground "firebrick"))))
     ...
     (gnus-group-news-3-face ((t (:bold t :foreground "MediumOrchid" :weight bold))))
     ...
     (gnus-signature-face ((t (:italic t :foreground "RoyalBlue" :slant italic))))
     ...
     (menu ((t (nil))))
     (message-cited-text-face ((t (:foreground "grey80"))))
     ...
     (modeline ((t (:background "black" :foreground "dark olive green" :box (:line-width 2) 
     		:family "helv" :height 1.15)))) ;; :italic t :bold t 
     (mode-line-inactive ((t (:background "black" :foreground "grey20" :box (:line-width 1) 
     		:family "helv" :height 1.15))))
     (modeline-buffer-id ((t (:bold t :background "black" :foreground "red" :weight bold :family "helv"))))
     (modeline-mousable ((t (:bold t :background "black" :foreground "red" :weight bold :family "helv"))))
     (modeline-mousable-minor-mode ((t (:bold t :background "black" :foreground "red" :weight bold :family "helv"))))
     (mouse ((t (:background "black"))))
     (paren-match ((t (:foreground "black" :background "orchid1"))) t)
     ...
     (secondary-selection ((t (:background "MediumOrchid" :foreground "SlateBlue"))))
     (show-paren-match-face ((t (:bold t :background "MediumOrchid" :foreground "black" :weight bold))))
     (show-paren-mismatch-face ((t (:background "Red" :foreground "grey80"))))
     (swbuff-current-buffer-face ((t (:bold t :foreground "red" :weight bold))))
     (text-cursor ((t (:background "Red" :foreground "grey80"))))
     ...
     (w3m-header-line-location-content-face ((t (:background "dark olive green" :foreground "snow4"))))
     ...
     (woman-unknown-face ((t (:foreground "firebrick"))))
     (zmacs-region ((t (:background "dark cyan" :foreground "cyan")))))))
     
     
     
     (setq-default mode-line-format (list "    %b           ( line: %l  column: %c )          "    
     		"( major-mode: "  'mode-name "   minor-modes: " 'minor-mode-alist " )"))
